                                           ...
                                           <!--  <div>
                                            ...
                                            <div>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <input type="hidden" name="id" class="trip_id" value="{{$trip_people->trip_id}}">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="date" class="form-control end_date" value="{{$trip->trip_end_date}}" id="dateInput">
                                        ...
                                        <div class="tab-pane fade" id="v-pills-bill-address" role="tabpanel" aria-labelledby="v-pills-bill-address-tab">
                                            ...
                                            <form action="{{url('add_trip_TripPeople')}}" method="post" enctype="multipart/form-data" parsley-validate>
                                                ...
                                                <div>
                                                    ...
                                                    <input type="hidden" class="append_trip_id" value="{{$trip_people->trip_id}}" name="trip_id">
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select name="document_type" id="" class="form-control" required>
                                                                ...
                                                                @foreach($document_type as $document_type_data)
                                                                    ...
                                                                    <option @if($document_type_data->id == $trip_people->document_type) selected @endif value="{{$document_type_data->id}}">{{$document_type_data->name}}</option>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <a target="_blank" href="{{asset('document_image/'.$trip_people->document_id_data)}}">View</a>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select name="residence_country" class="form-select" id="country" required>
                                                                ...
                                                                @foreach($country as $country_data)
                                                                    ...
                                                                    <option @if($country_data->id == $trip_people->residence_country) selected @endif value="{{$country_data->id}}">{{$country_data->name}}</option>
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <input type="text" value="{{$trip_people->residence_city}}" name="residence_city" class="form-control" id="address" placeholder="City" required/>
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <input type="text" value="{{$trip_people->residence_post_code}}" name="residence_post_code" class="form-control" id="address" placeholder="Postal Code" required/>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text" value="{{$trip_people->contacts_email}}" name="contacts_email" class="form-control" id="address" placeholder="Email" readonly/>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="number" value="{{$trip_people->contacts_phone}}" required name="contacts_phone" class="form-control" id="address" placeholder="Phone" readonly/>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <select class="form-control" name="visa_motive" id="">
                                                                ...
                                                                @foreach($motivation_of_trip as $motivation_of_trip_data)
                                                                    ...
                                                                    <option @if($motivation_of_trip_data->id == $trip_people->visa_motive) selected @endif value="{{$motivation_of_trip_data->id}}">{{$motivation_of_trip_data->name}}</option>
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <a target="_blank" href="{{asset('visa_document/'.$trip_people->document_image)}}">View</a>
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <select class="form-control" name="motivation_of_trip" id="" required>
                                                                ...
                                                                @foreach($motivation_of_trip as $motivation_of_trip_data)
                                                                    ...
                                                                    <option @if($motivation_of_trip_data->id == $trip_people->motivation_of_trip) selected @endif value="{{$motivation_of_trip_data->id}}">{{$motivation_of_trip_data->name}}</option>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select class="form-select" required name="originating_from_country" id="country">
                                                                ...
                                                                @foreach($country as $country_data)
                                                                    ...
                                                                    <option @if($country_data->id == $trip_people->orginating_form_country) selected @endif value="{{$country_data->id}}">{{$country_data->name}}</option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">  
                                                            ...
                                                            <input type="text"  value="{{$trip_people->hotel_name}}" class="form-control" name="hotel_name" id="address" placeholder="Hotel Name"/>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" value="{{$trip_people->room_no}}" class="form-control" name="room_no" id="address" placeholder="Room No."/>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select class="form-select" required name="arrival_crossing_point_border_crossing_point" id="country">
                                                                ...
                                                                @foreach($arrival_crossing_point as $arrival_crossing_point_data)
                                                                    ...
                                                                    <option @if($arrival_crossing_point_data->id == $trip_people->arrival_crossing_point_border_crossing_point) selected @endif value="{{$arrival_crossing_point_data->id}}">{{$arrival_crossing_point_data->name}}</option>
                                                        ...
                                                        <div class="col-md-6">  
                                                            ...
                                                            <input type="date" required name="arrival_crossing_point_arrival_date" class="form-control" value="{{$trip_people->arrival_crossing_point_arrival_date}}" id="address"/>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select class="form-select" required name="departure_crossing_point_border_crossing_point" id="country">
                                                                ...
                                                                @foreach($arrival_crossing_point as $arrival_crossing_point_data)
                                                                    ...
                                                                    <option @if($arrival_crossing_point_data->id == $trip_people->departure_crossing_point_border_crossing_point) selected @endif value="{{$arrival_crossing_point_data->id}}">{{$arrival_crossing_point_data->name}}</option>
                                                        ...
                                                        <div class="col-md-6">  
                                                            ...
                                                            <input type="date" name="departure_crossing_point_departure_date" class="form-control" value="{{$trip_people->departure_crossing_point_departure_date}}" id="address" required/>
