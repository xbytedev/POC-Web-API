                        ...
                        <div class="row gy-5">
                            <div class="col-lg-3">
                                <div class="nav flex-column custom-nav nav-pills" role="tablist" aria-orientation="vertical">
                                    <button class="nav-link" id="v-pills-bill-info-tab" data-bs-toggle="pill" data-bs-target="#v-pills-bill-info" type="button" role="tab" aria-controls="v-pills-bill-info" aria-selected="true">
                                        <span class="step-title me-2">
                                            <i class="ri-close-circle-fill step-icon me-2"></i>
                                            Trip
                                        </span>
                                    </button>
                                    <button class="nav-link active click_button_People" id="v-pills-bill-address-tab "  data-bs-toggle="pill" data-bs-target="#v-pills-bill-address" type="button" role="tab" aria-controls="v-pills-bill-address" aria-selected="false">
                                    <!-- disabled -->
                                        <span class="step-title me-2">
                                            <i class="ri-close-circle-fill step-icon me-2"></i>
                                            2 People
                            ...
                            <div class="col-lg-7 mx-auto">
                                <div class="px-lg-4">
                                    <div class="tab-content">
                                            ...
                                            <div>
                                                <div class="row g-3">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" class="form-control trip_name" id="firstName" placeholder="Enter Trip Name" value="{{$trip->trip_name}}" />
                                                        <p class="error_message_trip_name" style="color:red"></p>
                                                    </div>

                                                    <div class="col-sm-6">
                                                        <label for="dateInput" class="form-label">Start Date</label>
                                                        <input type="date" value="{{$trip->trip_start_date}}" class="form-control start_date" id="dateInput">
                                                        <p style="color:red" class="error_message_start_date"></p>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="dateInput" class="form-label">End Date</label>
                                                        <input type="date" value="{{$trip->trip_end_date}}" class="form-control end_date" id="dateInput">
                                        ...
                                        <!-- end tab pane -->
                                        <div class="tab-pane fade active show" id="v-pills-bill-address" role="tabpanel" aria-labelledby="v-pills-bill-address-tab">

                                            <form action="{{url('add_trip_TripPeople')}}" method="post" enctype="multipart/form-data" parsley-validate>
                                                @csrf
                                                <div>
                                                    <input type="hidden" value="{{$trip->id}}" class="append_trip_id" name="trip_id">
                                                    <div class="col-12">
                                                        <label for="address" class="form-label">Select person</label>
                                                        <select name="" class="form-control get_trip_people_datas" id="">
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-12">
                                                            ...
                                                            <input type="text" class="form-control name" name="name" id="address" placeholder="Name" required/>                                                            
                                                        </div>
                                                        <div class="col-12">
                                                            <label for="address" class="form-label">Family Name</label>
                                                            <input type="text" class="form-control family_name" name="family_name" id="address" placeholder="Family Name" required/>
                                                        </div>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <label for="" class="form-label">Gender</label><br>
                                                                <div class="form-check form-check-inline">
                                                                    <input id="credit" name="gender" type="radio" class="form-check-input female" checked required/>
                                                                    <label class="form-check-label" for="credit" value="Female">Female</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input id="debit" name="gender" type="radio" value="Male" class="form-check-input male" required />
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select name="document_type" id="document_type" class="form-control document_type" required>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input type="text" class="form-control document_number" name="document_number" id="address2" placeholder="Document Number" required/>
                                                        </div>

                                                        <div class="col-12">
                                                            <label for="address" class="form-label">Valid Until</label>
                                                            <input type="date" name="valid_untill" class="form-control valid_untill" id="address" required/>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="file" name="document_id_data" class="form-control document_id_data" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text" class="form-control residence_address" name="residence_address" id="address" placeholder="Street Address" required/>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label for="country" class="form-label">Country</label>
                                                            <select name="residence_country" class="form-select residence_country" id="country" required>
                                                                <option>Select Country</option>
                                                                @foreach($country as $country_data)
                                                                    <option class="residence_country_{{$country_data->id}}" value="{{$country_data->id}}">{{$country_data->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <input type="text" name="residence_city" class="form-control residence_city" id="address" placeholder="City" required/>
                                                        </div>

                                                        <div class="col-4">
                                                            <label for="address" class="form-label">Postal Code</label>
                                                            <input type="text" name="residence_post_code" class="form-control residence_post_code" id="address" placeholder="Postal Code" required/>
                                                        </div>
                                                    </div>
                                                    <br><h4>Contacts</h4>
                                                    <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="number" required name="contacts_phone" class="form-control contacts_phone" id="address" placeholder="Phone"/>
                                                    </div>
                                                    <br><h4>Trip Data</h4>
                                                    <div class="col-12">
                                                        <label for="address" class="form-label">Visa Number</label>
                                                        <input type="text" name="trip_data_visa_information" class="form-control trip_data_visa_information" id="address" placeholder="Visa Number"/>
                                                    </div>
                                                    <div class="col-12">
                                                        <label for="address" class="form-label">Expiration Date</label>
                                                        <input type="date" name="experience_date" class="form-control experience_date" id="address" />
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <label for="address" class="form-label">Visa motive</label>
                                                            <select class="form-control visa_motive" name="visa_motive" id="">
                                                                <option value="">Select visa motive</option>
                                                                @foreach($motivation_of_trip as $motivation_of_trip_data)
                                                                    <option class="visa_motive_{{$motivation_of_trip_data->id}}" value="{{$motivation_of_trip_data->id}}">{{$motivation_of_trip_data->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="col-6">
                                                            <label for="address" class="form-label">Upload Visa Document</label>
                                                            <input type="file"  name="visa_document" class="form-control visa_document">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            ...
                                                            <select class="form-control motivation_of_trip" name="motivation_of_trip" id="" required>
                                                                <option value="">Select Motivation</option>
                                                                @foreach($motivation_of_trip as $motivation_of_trip_data)
                                                                    <option class="motivation_of_trip_{{$motivation_of_trip_data->id}}" value="{{$motivation_of_trip_data->id}}">{{$motivation_of_trip_data->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="col-6">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text" class="form-control document_number_pnr" name="document_number_pnr" required placeholder="Document number/PNR">
                                                    </div>
                                                    <br><h4>Originating From</h4>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label for="country" class="form-label">Country</label>
                                                            <select class="form-select originating_from_country" required name="originating_from_country" id="country">
                                                                <option>Select Country</option>
                                                                @foreach($country as $country_data)
                                                                    <option class="originating_from_country_{{$country_data->id}}" value="{{$country_data->id}}">{{$country_data->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-4">
                                                            <label for="address" class="form-label">City</label>
                                                            <input type="text" class="form-control originating_from_city" required name="originating_from_city" id="address" placeholder="City"/>
                                                        </div>

                                                        <div class="col-4">
                                                            <label for="address" class="form-label">Via</label>
                                                            <input type="text" name="originating_from_via" class="form-control originating_from_via" id="address" placeholder="Via"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">  
                                                            ...
                                                            <input type="text" class="form-control hotel_name" name="hotel_name" id="address" placeholder="Hotel Name"/>
                                                        </div>
                                                        <div class="col-md-6">  
                                                            <label for="address" class="form-label">Room No.</label>
                                                            <input type="text" class="form-control room_no" name="room_no" id="address" placeholder="Room No."/>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">  
                                                            <label for="address" class="form-label">Arrival Date</label>
                                                            <input type="date" name="arrival_date" class="form-control arrival_date" id="address"/>
                                                        </div>
                                                        <div class="col-md-6">  
                                                            <label for="address" class="form-label">Departure Date</label>
                                                            <input type="date" name="dep_date" class="form-control dep_date" id="address"/>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select class="form-select arrival_crossing_point_border_crossing_point" required name="arrival_crossing_point_border_crossing_point" id="country">
                                                                ...
                                                                @foreach($arrival_crossing_point as $arrival_crossing_point_data)
                                                                    <option class="arrival_crossing_point_border_crossing_point_{{$arrival_crossing_point_data->id}}" value="{{$arrival_crossing_point_data->id}}">{{$arrival_crossing_point_data->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="col-md-6">  
                                                            <label for="address" class="form-label">Arrival Date</label>
                                                            <input type="date" required name="arrival_crossing_point_arrival_date" class="form-control arrival_crossing_point_arrival_date" id="address"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <select class="form-select departure_crossing_point_border_crossing_point" required name="departure_crossing_point_border_crossing_point" id="country">
                                                                <option>Select Border Crossing Point</option>
                                                                @foreach($arrival_crossing_point as $arrival_crossing_point_data)
                                                                    <option class="departure_crossing_point_border_crossing_point_{{$arrival_crossing_point_data->id}}" value="{{$arrival_crossing_point_data->id}}">{{$arrival_crossing_point_data->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="col-md-6">  
                                                            <label for="address" class="form-label">Departure Date</label>
                                                            <input type="date" name="departure_crossing_point_departure_date" class="form-control departure_crossing_point_departure_date" id="address" required/>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        success: function(response){
            ...
            @foreach($country as $country_data)
                if(data.document_country == {{$country_data->id}}){
                    $('.document_country_{{$document_type_data->id}}').attr('selected',true);
                }
            @endforeach

            @foreach($country as $country_data)
                if(data.residence_country == {{$country_data->id}}){
                    $('.residence_country_{{$document_type_data->id}}').attr('selected',true);
                }
            @endforeach
            ...
            @foreach($motivation_of_trip as $motivation_of_trip_data)
                if(data.motivation_of_trip == {{$motivation_of_trip_data->id}}){
                    $('.motivation_of_trip_{{$document_type_data->id}}').attr('selected',true);
                }
            @endforeach

            @foreach($mean_of_transport as $mean_of_transport_data)
                if(data.mean_of_transport == {{$mean_of_transport_data->id}}){
                    $('.mean_of_transport_{{$mean_of_transport_data->id}}').attr('selected',true);
                }
            @endforeach

            @foreach($country as $country_data)
                if(data.orginating_form_country == {{$country_data->id}}){
                    $('.originating_from_country_{{$country_data->id}}').attr('selected',true);
                }
            @endforeach

            @foreach($arrival_crossing_point as $arrival_crossing_point_data)
                if(data.arrival_crossing_point_border_crossing_point == {{$arrival_crossing_point_data->id}}){
                    $('.arrival_crossing_point_border_crossing_point_{{$arrival_crossing_point_data->id}}').attr('selected',true);
                }
            @endforeach

            @foreach($arrival_crossing_point as $arrival_crossing_point_data)
                if(data.departure_crossing_point_border_crossing_point == {{$arrival_crossing_point_data->id}}){
                    $('.departure_crossing_point_border_crossing_point_{{$arrival_crossing_point_data->id}}').attr('selected',true);
                }
            @endforeach
