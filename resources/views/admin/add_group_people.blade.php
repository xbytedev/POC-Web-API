        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="code" required class="form-control" id="exampleInputEmail1" placeholder="Code">

                    <input type="hidden" name="group_id" value="{{$group_people_data->id}}">
                    
                    <input type="hidden" name="people_code" value="{{$group_people_data->group_code}}">
