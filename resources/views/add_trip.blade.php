                                                ...
                                                <div>
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <input type="date" min="<?php echo date('Y-m-d', strtotime(' + 2 day')); ?>"
                                                                class="form-control end_date" id="dateInput1">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="date" name="arrival_date"
                                                                    ...
                                                                    class="form-control arrival_date" id="arrival_date" />
                                                            </div>
                                                            <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-12 text-end">
                                                                <div class="align-items-start gap-3 mt-4">
                                                                    <button type="submit" name="add_person"
                                                                        class="btn btn-primary btn-label left ms-auto nexttab nexttab" data-nexttab="v-pills-payment-tab">
                                                                        <i class="ri-arrow-right-line label-icon m-lg-0 align-middle fs-16 ms-2"></i>Add person to this trip </button>
                                                                </div>
                                                            </div>
                                                            <!-- <div class="col-md-6">
...
@section('scripts')
    ...
    <script>
        $("#dateInput").change(function() {
            ...
            document.getElementById("arrival_crossing_point_arrival_date").setAttribute("min", date);
            document.getElementById("dep_date").setAttribute("min", date);
            document.getElementById("departure_crossing_point_departure_date").setAttribute("min", date);
            document.getElementById("dateInput1").setAttribute("min", date);
        });

        $("#dateInput1").change(function() {
            var date = $(this).val();
            document.getElementById("dep_date").setAttribute("max", date);
            document.getElementById("departure_crossing_point_departure_date").setAttribute("max", date);
            document.getElementById("arrival_date").setAttribute("max", date);
            document.getElementById("arrival_crossing_point_arrival_date").setAttribute("max", date);
        });
        ...
        $("#arrival_crossing_point_arrival_date").change(function() {
            var date = $(this).val();
            document.getElementById("departure_crossing_point_departure_date").setAttribute("min", date);
        });
        ...
        $(".get_trip_people_datas").change(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // $('.arrival_crossing_point_arrival_date').val(data
                    //     .arrival_crossing_point_arrival_date);
                    // $('.departure_crossing_point_departure_date').val(data
                    //     .departure_crossing_point_departure_date);
                },
                error: function() {},
            });
        })
